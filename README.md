...
* __An Openweathermap account. (https://openweathermap.org)__

If you want to use Firebase in your application, you can use the branch - [main](https://github.com/Sanarix/react-weather/tree/main).
...
* Remove __.template__ from the file name __weatherApi.template.json__
...
* Удалите вставку __.template__ из названия файла __weatherApi.template.json__
